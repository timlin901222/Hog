...
def swine_align(player_score, opponent_score):
    ...
    if min(player_score, opponent_score) == 0:
        return False
    elif max(player_score, opponent_score) % min(player_score, opponent_score) == 0:
        return min(player_score, opponent_score) >= 10
    else:
        gcd = 0
        for i in range(1, max(player_score, opponent_score) // 2 + 1):
    ...
    def say(score0, score1):
        if who:
            if score1 - last_score > running_high:
                print("%i point(s)! The most yet for Player 1" % (score1 - last_score))
            ...
            if score0 - last_score > running_high:
                print("%i point(s)! The most yet for Player 0" % (score0 - last_score))
